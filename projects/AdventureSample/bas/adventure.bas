...
4 REM
10 CLS : REM Put a statement here to clear the screen. If you are using a Radio Shack Model I, III, or 4, add a CLEAR statement. (See text.)
...
80 CLS : REM Put a statement here to clear the screen.
...
3520 IF OB(0)<>R AND OB(0)<>-1 THEN PRINT "THERE'S NO DIARY HERE!" : GOTO 100
...
3720 IF OB(1)<>R AND OB(1)<>-1 THEN PRINT "THERE'S NO BOX HERE!" : GOTO 100
...
3970 IF OB(6)<>R AND OB(6)<>-1 THEN PRINT "YOU DON'T HAVE THE BOTTLE!" : GOTO 100
...
4145 IF OB(7)<>R AND OB(7)<>-1 THEN PRINT "YOU DON'T HAVE THE LADDER!" : GOTO 100
4150 IF R<>7 THEN 4180
4160 PRINT "THE LADDER SINKS UNDER YOUR WEIGHT!"
4170 PRINT "IT DISAPPEARS INTO THE GROUND!" : OB(7)=0 : GOTO 100
...
4430 IF OB(10)<>0 THEN PRINT "THERE'S NOTHING ELSE THERE!" : GOTO 100
4440 PRINT "THERE'S SOMETHING THERE!" : OB(10)=6 : GOTO 100
