...
namespace GWExpr.Test
{
    ...
    public sealed class Precedence
    {
        ...
        [InlineData("1+2/3", "Add(L(1), Div(L(2), L(3)))")]
        [InlineData("1-2*3", "Sub(L(1), Mult(L(2), L(3)))")]
        [InlineData("1-2/3", "Sub(L(1), Div(L(2), L(3)))")]
        [InlineData("(1+2)/3", "Div(Add(L(1), L(2)), L(3))")]
        [InlineData("(1-2)/3", "Div(Sub(L(1), L(2)), L(3))")]
        [InlineData("(1+2)*3", "Mult(Add(L(1), L(2)), L(3))")]
        [InlineData("(1-2)*3", "Mult(Sub(L(1), L(2)), L(3))")]
        [InlineData("(1*2)/3", "Div(Mult(L(1), L(2)), L(3))")]
        [InlineData("(1*2)+3", "Add(Mult(L(1), L(2)), L(3))")]
        [InlineData("(1/2)-3", "Sub(Div(L(1), L(2)), L(3))")]
        [InlineData("1*2^3", "Mult(L(1), Pow(L(2), L(3)))")]
        [InlineData("1^2/3", "Div(Pow(L(1), L(2)), L(3))")]
        [InlineData("1^2+3", "Add(Pow(L(1), L(2)), L(3))")]
        [InlineData("1^2-3", "Sub(Pow(L(1), L(2)), L(3))")]
        [InlineData("1+2^3", "Add(L(1), Pow(L(2), L(3)))")]
        [InlineData("1-2^3", "Sub(L(1), Pow(L(2), L(3)))")]
