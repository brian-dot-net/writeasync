...
namespace GWExpr.Test
{
    ...
    {
        [InlineData("1+2*3", "Add(L(1), Multiply(L(2), L(3)))")]
        [InlineData("1+2/3", "Add(L(1), Divide(L(2), L(3)))")]
        [InlineData("1-2*3", "Subtract(L(1), Multiply(L(2), L(3)))")]
        ...
        [InlineData("(1+2)*3", "Multiply(Add(L(1), L(2)), L(3))")]
        [InlineData("(1-2)*3", "Multiply(Subtract(L(1), L(2)), L(3))")]
        [InlineData("(1*2)/3", "Divide(Multiply(L(1), L(2)), L(3))")]
        [InlineData("(1*2)+3", "Add(Multiply(L(1), L(2)), L(3))")]
        [InlineData("(1/2)-3", "Subtract(Divide(L(1), L(2)), L(3))")]
        [InlineData("1*2^3", "Multiply(L(1), Pow(L(2), L(3)))")]
        ...
        [InlineData("1*2 AND 3", "And(Multiply(L(1), L(2)), L(3))")]
        ...
        [InlineData("1*2 OR 3=4", "Or(Multiply(L(1), L(2)), Eq(L(3), L(4)))")]
        [InlineData("1*2 OR 3<>4", "Or(Multiply(L(1), L(2)), Ne(L(3), L(4)))")]
