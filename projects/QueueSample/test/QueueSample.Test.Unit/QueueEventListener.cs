//-----------------------------------------------------------------------
// <copyright file="QueueEventListener.cs" company="Brian Rogers">
...
namespace QueueSample.Test.Unit
{
    ...
    internal sealed class QueueEventListener : EventListener
    {
        private readonly QueueEventSource eventSource;

        public QueueEventListener(QueueEventSource eventSource, EventLevel level, EventKeywords keywords)
        {
        ...
        public void VerifyEvent(QueueEventId id, EventLevel level, EventKeywords keywords, params object[] payloadItems)
        {
            this.VerifyEvent(id, level, keywords, EventOpcode.Info, payloadItems);
        }

        public void VerifyEvent(QueueEventId id, EventLevel level, EventKeywords keywords, EventOpcode opcode, params object[] payloadItems)
        {
